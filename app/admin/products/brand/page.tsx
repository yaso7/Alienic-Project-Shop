...
export default function BrandProductsPage() {
  ...
  const [madeBy, setMadeBy] = useState<string>('all')
  ...
  useEffect(() => {
    ...
    fetchCategories()
    fetchAdminUsers()
  }, [search, status, category, madeBy, addedBy, page, sortBy, sortOrder])
      ...
      <TableFilters
        ...
        additionalFilters={
          <div className="flex gap-2 flex-wrap">
            ...
            <Select value={madeBy} onValueChange={(value) => {
              setMadeBy(value)
              setPage(1)
            }}>
            ...
            <Select value={addedBy} onValueChange={(value) => {
              setAddedBy(value)
              setPage(1)
            }}>
              <SelectTrigger className="w-[160px]">
              ...
              <SelectContent>
                <SelectItem value="all">All adders</SelectItem>
                {adminUsers.map((user) => (
                  <SelectItem key={user.id} value={user.id}>
                    {user.email}
                  </SelectItem>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        ...
                        <Badge 
                          ...
                          className={product.status === 'Available' ? 'text-green-600' : ''}
                        >
                          {product.status}
                        </Badge>
                      </div>
